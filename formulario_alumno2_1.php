...
<div class="container">
     <nav class ="navbar navbar-light bg-light">
        ...
        <form name="" action="formulario_alumno2_1.php" method="POST" id="formulario">
            <p>Nro de DNI: <br><input type="number" class="datos" id="DNI" name="DNI" placeholder="Ingrese solo numeros" value="39204535"></p>
            <p>Nro de Legajo: <br><input type="password" class="datos" id="Legajo" name="Legajo" placeholder="Ingrese solo numeros" value="7314"></p> 
